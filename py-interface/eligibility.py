...
class EligibilityChecker:
    ...
    def check_hydrological_condition(
        ...
        self.criteria['hydrology'] = EligibilityCriterion(
            ...
            threshold=threshold,
            message=(
                f'Adequate water availability (NDWI: {ndwi_mean:.3f})' if passed
    ...
    def check_minimum_biomass(
        ...
        self.criteria['biomass'] = EligibilityCriterion(
            ...
            threshold=min_ndvi,
            message=(
                f'Sufficient vegetation (NDVI: {ndvi_mean:.3f})' if passed
    ...
    def check_minimum_area(
        ...
        self.criteria['area'] = EligibilityCriterion(
            ...
            threshold=min_area,
            message=(
                f'Area adequate ({area_ha:.2f} ha)' if passed
    ...
    def check_data_quality(
        ...
        self.criteria['data_quality'] = EligibilityCriterion(
            ...
            message=(
                f'Good data coverage ({coverage_percent:.1f}%)' if passed
    ...
    def check_temporal_stability(
        ...
        self.criteria['stability'] = EligibilityCriterion(
            ...
            threshold=max_cv,
            message=(
                f'Stable vegetation (CV: {cv:.3f})' if passed
    ...
    def get_final_status(self) -> str:
        ...
        if all_passed:
            ...
            failed = [
                c.name for c in self.criteria.values()
                if not c.passed
            ]
